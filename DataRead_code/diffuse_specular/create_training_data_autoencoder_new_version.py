...
training_data_filename = 'lf_patch_autoencoder_4_48.hdf5'
...
for lf_name in data_folders:
  ...
  # lf_tools.save_image( training_data_dir + 'diffuse' +lf_name, cv_diffuse)
  # glossy LF
  ...
  # lf_tools.save_image(training_data_dir + 'diffuse' + lf_name, lf_tools.cv(LF_diffuse))
  # lf_tools.save_image(training_data_dir + 'specular' + lf_name, lf_tools.cv(LF_specular))
  #
  # # a colormap and a normalization instance
  # import matplotlib.pyplot as plt
  # cmap = plt.cm.jet
  # norm = plt.Normalize(vmin=disp_gt.min(), vmax=disp_gt.max())

  # map the normalized data to colors
  # image is now RGBA (512x512x4)
  # image = cmap(norm(disp_gt))

  # save the image
  # plt.imsave(training_data_dir + 'disp' + lf_name + '.png', disp_gt)
